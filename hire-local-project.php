...
<div class="top-page">
           <img src="img/hirelocal/Hire_Local_logo%201.png" width="300px">
            <h1>HIRE LOCAL Project — Call for subjects</h1> 
     ...
     <div class="container">
        ...
        <p><dropcap>A</dropcap>fter graduating from college, I decided to move to San Francisco to start a new entrepreneurial endeavor. I wasn’t sure about the outcome, but I knew my heart wanted to be there. So, I traveled to San Francisco to tangibly explore the surface. Sadly, during the third day of my visit; I got robbed. They stole everything I traveled with. I lost a lot in terms of valuables. After the robbery, I was forced to cut my trip short and travel back to Jacksonville. That trip put me, at that time, in an insipid financial situation. The next move was to find a job to cover my deficits. I, unsuccessfully, spent about two months looking for a job. 
...
<p>After all, I still feel like there isn’t sufficient impacts as there are still people here struggling to find a job — mostly creative people. To continue the work, I’m starting a project entitled “HIRE LOCAL” that will focus on hiring local talents and sharing stories of small business owners in Jacksonville, Florida.
 ...
 <p>I want to accomplish three main goals after this project: increase the local employment rates for creative entrepreneurs. I also want to increase sales for participating small business owners by encouraging people to shop local. And lastly, I want to bring attention to folks in business in Jacksonville whose stories have never been heard, considered and celebrated.
</p>

        <br>    

 <p>Portraits and interviews will be conducted at our studios mostly over the weekends. We will make arrangements for video interviews with participants at their office, shop, home and other locations.
</p>      
<br>
   <p><b>Think it’s a good movement?</b></p>
   <br>
