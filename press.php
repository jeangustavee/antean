...
<body>
    ...
    <div class="container">
        <h1>PRESS</h1><hr width="80%"><br>
        <!-- row 1 -->
         <div class="section group">
	<div class="col span_1_of_2">
        <a href="https://www.dropbox.com/sh/azd0cs2d7d506vk/AAAjB6N9izCtAK3CMvcg27Vba?dl=0" target="_blank"><img src="img/antean_press_logo.jpg" width="100%"></a>
        <h3>Logo Assets</h3> 
	</div>
	
             
	<div class="col span_1_of_2">
        <a href="https://www.dropbox.com/sh/dd6yiyolm3aeaer/AADqhyINSMrvwB-RIh6wqS6ia?dl=0" target="_blank"> <img src="img/Antean_Interior_Lobby.jpg" width="100%"></a>
